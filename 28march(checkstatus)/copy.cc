...
int Copy<T>::CopyApiCall() {
  ...
  switch (mode) {
    case 'S': {
      ...
      if (status != CUBLAS_STATUS_SUCCESS) {
        std::cout << "!!!!  Scopy kernel execution error\n";
        FreeMemory();
        return EXIT_FAILURE;
      }
    ...
    case 'D': {
      ...
      if (status != CUBLAS_STATUS_SUCCESS) {
        std::cout << "!!!!  Dcopy kernel execution error\n";
        FreeMemory();
        return EXIT_FAILURE;
      }
    ...
    case 'C': {
      ...
      if (status != CUBLAS_STATUS_SUCCESS) {
        std::cout << "!!!!  Ccopy kernel execution error\n";
        FreeMemory();
        return EXIT_FAILURE;
      }
    ...
    case 'Z': {
      ...
      if (status != CUBLAS_STATUS_SUCCESS) {
        std::cout << "!!!!  Zcopy kernel execution error\n";
        FreeMemory();
        return EXIT_FAILURE;
      }
