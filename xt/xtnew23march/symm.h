...
class Symm {
  public:
     ...
     */
    Symm(size_t A_row, size_t A_col, size_t B_row, size_t B_col, size_t C_row, size_t C_col, T alpha, T beta, char mode);
    ...
    /**
     * SymmAPICall function - To allocate Host memory and ,
