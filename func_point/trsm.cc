...
void mode_S(int A_row, int A_col, int B_row, int B_col, double alpha_real, double alpha_imaginary) {
...
void mode_C(int A_row, int A_col, int B_row, int B_col, double alpha_real, double alpha_imaginary) {
...
void mode_Z(int A_row, int A_col, int B_row, int B_col, double alpha_real, double alpha_imaginary) {
