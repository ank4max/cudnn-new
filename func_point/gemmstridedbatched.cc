...
void mode_S(int A_row, int A_col, int B_row, int B_col, int C_row, int C_col, int batch_count, double alpha_real, double alpha_imaginary,
  ...
  GemmStridedBatched<float> Sgemmstridedbatched(A_row, A_col, B_row, B_col, C_row, C_col, batch_count, alpha, beta, 'S');
  Sgemmstridedbatched.GemmStridedBatchedApiCall();
}
...
void mode_D(int A_row, int A_col, int B_row, int B_col, int C_row, int C_col, int batch_count, double alpha_real, double alpha_imaginary, 
  ...
  GemmStridedBatched<double> Dgemmstridedbatched(A_row, A_col, B_row, B_col, C_row, C_col, batch_count, alpha, beta, 'D');
  Dgemmstridedbatched.GemmStridedBatchedApiCall();
}
...
void mode_C(int A_row, int A_col, int B_row, int B_col, int C_row, int C_col, int batch_count, double alpha_real, double alpha_imaginary,
  ...
  GemmStridedBatched<cuComplex> Cgemmstridedbatched(A_row, A_col, B_row, B_col, C_row, C_col, batch_count, alpha, beta, 'C');
  Cgemmstridedbatched.GemmStridedBatchedApiCall();
}
...
void mode_Z(int A_row, int A_col, int B_row, int B_col, int C_row, int C_col, int batch_count, double alpha_real, double alpha_imaginary,
  ...
  GemmStridedBatched<cuDoubleComplex> Zgemmstridedbatched(A_row, A_col, B_row, B_col, C_row, C_col, batch_count, alpha, beta, 'Z');
  Zgemmstridedbatched.GemmStridedBatchedApiCall();  
}

void mode_H(int A_row, int A_col, int B_row, int B_col, int C_row, int C_col, int batch_count, double alpha_real, double alpha_imaginary,
            double beta_real, double beta_imaginary) {
