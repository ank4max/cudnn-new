...
class Trmm {
  ...
  public:
    Trmm(int A_row, int A_col, int B_row, int B_col, int C_row, int C_col, T alpha, T beta, char mode)
...
int main(int argc, char **argv) {
  ...
  switch (mode) {
    case 'S': {
      ...
      Trmm<float> Strmm(A_row, A_col, B_row, B_col, C_row, C_col, alpha, beta, mode);
    ...
    case 'D': {
      ...
      Trmm<double> Dtrmm(A_row, A_col, B_row, B_col, C_row, C_col, alpha, beta, mode);
    ...
    case 'C': {
      ...
      Trmm<cuComplex> Ctrmm(A_row, A_col, B_row, B_col, C_row, C_col, alpha, beta, mode);
    ...
    case 'Z': {
      ...
      Trmm<cuDoubleComplex> Ztrmm(A_row, A_col,B_row, B_col, C_row, C_col, alpha, beta, mode);
