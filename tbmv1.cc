...
template<class T>
Tbmv<T>::Tbmv(int A_row, int A_col, int vector_length, int sub_diagonals, char mode) : A_row(A_row), A_col(A_col), 
...
void mode_S(int A_row, int A_col, int vector_length, int sub_diagonals) {
  ...
  Tbmv<float> Stbmv(A_row, A_col, vector_length, sub_diagonals, 'S' );
  Stbmv.TbmvApiCall();
}

void mode_D(int A_row, int A_col, int vector_length, int sub_diagonals) {            

  Tbmv<double> Dtbmv(A_row, A_col, vector_length, sub_diagonals, 'D');
  Dtbmv.TbmvApiCall();
}

void mode_C(int A_row, int A_col, int vector_length, int sub_diagonals) {
            
  Tbmv<cuComplex> Ctbmv(A_row, A_col, vector_length, sub_diagonals, 'C');
  Ctbmv.TbmvApiCall();
}

void mode_Z(int A_row, int A_col, int vector_length, int sub_diagonals) {
            
  Tbmv<cuDoubleComplex> Ztbmv(A_row, A_col, vector_length, sub_diagonals, 'Z');
  Ztbmv.TbmvApiCall();
}
