...
/**
 * Class Syrkx contains Syrkx API which performs variation of the symmetric rank- k update : C = alpha * A * B^T + beta * C
...
class Syrkx {
  public:
    ...
    /**
     * SyrkxAPICall function - To allocate Host and Device memory,
