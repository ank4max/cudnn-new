...
int main(int argc, char **argv) {
  ...
  //! Calling Syr2k API based on mode
  switch (mode) {
    case 'S': {
      float alpha = (float)alpha_real;
      float beta = (float)beta_real;

      Syr2k<float> Ssyr2k(A_row, A_col, B_row, B_col, C_row, C_col, alpha, beta, mode);
      status = Ssyr2k.Syr2kApiCall();
      break;
    }
    ...
    case 'D': {
      ...
      Syr2k<double> Dsyr2k(A_row, A_col, B_row, B_col, C_row, C_col, alpha, beta, mode);
      status = Dsyr2k.Syr2kApiCall();
      break;
    }
    ...
    case 'C': {
      ...
      Syr2k<cuComplex> Csyr2k(A_row, A_col, B_row, B_col, C_row, C_col, alpha, beta, mode);
      status = Csyr2k.Syr2kApiCall();
      break;
    }
    ...
    case 'Z': {
      ...
      Syr2k<cuDoubleComplex> Zsyr2k(A_row, A_col,B_row, B_col, C_row, C_col, alpha, beta, mode);
      status = Zsyr2k.Syr2kApiCall();
      break;
    }          
  }
