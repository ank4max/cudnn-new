...
int main(int argc, char **argv) {
  ...
  switch (mode) {
    case 'S': {
      ...
      Symm<float> Ssymm(A_row, A_col, B_row, B_col, C_row, C_col, alpha, beta, mode);
      status = Ssymm.SymmApiCall();
      break;
    }
    ...
    case 'D': {
      ...
      Symm<double> Dsymm(A_row, A_col, B_row, B_col, C_row, C_col, alpha, beta, mode);
      status = Dsymm.SymmApiCall();
      break;
    }
    ...
    case 'C': {
      ...
      Symm<cuComplex> Csymm(A_row, A_col, B_row, B_col, C_row, C_col, alpha, beta, mode);
      status = Csymm.SymmApiCall();
      break;
    }
    ...
    case 'Z': {
      ...
      Symm<cuDoubleComplex> Zsymm(A_row, A_col, B_row, B_col, C_row, C_col, alpha, beta, mode);
      status = Zsymm.SymmApiCall();
      break;
    }
  }
