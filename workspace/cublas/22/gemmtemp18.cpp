...
int Gemm(int A_row, int A_col, int B_row, int B_col, int C_row, int C_col,T1 alpha_real, T1 alpha_imaginary,T1 beta_real , T1 beta_imaginary ,char n) {
  ...
  if(n == 's' || n == 'd') {
    DefineMat<T>(HostMatA, A_row, A_col);
    DefineMat<T>(HostMatB, B_row, B_col);
    DefineMat<T>(HostMatC, C_row, C_col);

  }
  else if(n == 'c' || n == 'z') {
    DefineCuMat<T>(HostMatA, A_row, A_col);
    DefineCuMat<T>(HostMatB, B_row, B_col);
    DefineCuMat<T>(HostMatC, C_row, C_col);
  }
  ...
  if(n == 's' || n == 'd') {
    ...
    std::cout << "\nMatrix A:\n";
    PrintMatrix <T> (HostMatA, A_row, A_col);
    std::cout << "\nMatrix B:\n";
    PrintMatrix <T> (HostMatB, B_row, B_col);
    std::cout << "\nMatrix C:\n";
    ...
    // printing input matrices
    std::cout << "\nMatrix A:\n";
    PrintCuMatrix <T> (HostMatA, A_row, A_col);
    std::cout << "\nMatrix B:\n";
    PrintCuMatrix <T> (HostMatB, B_row, B_col);
    std::cout << "\nMatrix C:\n";
    PrintCuMatrix <T> (HostMatC, C_row, C_col);
  }
