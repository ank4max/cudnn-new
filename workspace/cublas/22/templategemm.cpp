...
template < class T>
int Gemm(int A_row, int A_col, int B_row, int B_col, int C_row, int C_col, T alpha, T beta , char n) {
...
int main (int argc, char **argv) {
  ...
  case 'd' :
    ...
    Gemm <double> (A_row, A_col, B_row, B_col, C_row, C_col, alpha1, beta1, n);
    break;
