...
void  mat_fillupMatrix(T_ELEM *A , int lda , int rows, int cols, int seed = 0);
...
template void  mat_fillupMatrix<float>(float *A , int lda , int rows, int cols, int seed);
template void  mat_fillupMatrix<double>(double *A , int lda , int rows, int cols, int seed);
