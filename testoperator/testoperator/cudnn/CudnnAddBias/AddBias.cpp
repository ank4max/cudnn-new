...
const char *sSDKname = "BatchNormsalization";
...
/*
	cudnnFilterDescriptor_t  bias_desc;
cudnnFilterDescriptor_t  output_data_desc;
...
int main(int argc, char *argv[])
{
    ...
    {
        fprintf(stdout, "CUDNN Intialization failed: \n");
        exit(EXIT_FAILURE);
    }
